...
const Header = () => {
    ...
    let [isScrollDown, setScrollDown] = useState<number>(
    ...
    const isShowHeader = (): void => {
        scrollY - preScrollY > 0
            ? setScrollDown(scrollDirection.scrollDown)
            : setScrollDown(scrollDirection.scrollup);
    };
    useEffect(() => {
    ...
    return (
        <div
            className={`${Styled.headerContainer}  ${
                isScrollDown == 1 ? Styled.headerContainerScrollDown : null
            } `}
        >
